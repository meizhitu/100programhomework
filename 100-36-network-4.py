...
def getCityWeatherDetail_SixDay(cityID):
    ...
    try:
        ...
        content = "#" + city + "#" + u"\n<指数> " + u"穿衣:" + cy + u" 紫外线:" + zw + u" 洗车:" + xc \
                  + u" 旅游:" + tr + u" 舒适度:" + co + u" 晨练:" + cl + u" 晾晒:" + ls + u" 过敏:" + ag + "\n" \
                  + u"<天气>" + u" 1天:" + temp1 + " " + weather1 + u" 2天:" + temp2 + " " + weather2 + u" 3天:" + temp3 + " " + weather3 \
                  + u" 4天:" + temp4 + " " + weather4 + u" 5天:" + temp5 + " " + weather5 + u" 6天:" + temp6 + " " + weather6
...
def getCityWeather_AllDay(cityID):
    ...
    try:
        ...
        content = city + "," + weather + u",最高气温:" + temp1 + u",最低气温:" + temp2 + u",发布时间:" + ptime
